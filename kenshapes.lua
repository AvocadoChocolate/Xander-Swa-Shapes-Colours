...
local t1 = {text="mraba",image="vierkant.png",sound="vwortel.mp3"}
local t2 = {text="pembe tatu",image="driehoek.png",sound="vboontjie.mp3"}
local t3 = {text="moyo",image="hart.png",sound="vkomkommer.mp3"}
local t4 = {text="duara",image="sirkel.png",sound="vuie.mp3"}
local t6 = {text="nyota",image="ster.png",sound="vsoetrisse.mp3"}
local t5 = {text="mstatili",image="reghoek.png",sound="vspinasie.mp3"}
