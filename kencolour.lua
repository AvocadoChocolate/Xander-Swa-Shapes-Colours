...
local t1 = {text="bluu",image="blou.png",sound="vwortel.mp3"}
local t2 = {text="machungwa",image="oranje.png",sound="vboontjie.mp3"}
local t3 = {text="nyekundu",image="rooi.png",sound="vkomkommer.mp3"}
local t4 = {text="manjano",image="geel.png",sound="vuie.mp3"}
local t6 = {text="kijani",image="groen.png",sound="vsoetrisse.mp3"}
local t5 = {text="zambarau",image="pers.png",sound="vspinasie.mp3"}
